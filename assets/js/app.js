...
(function () {
  const texts = {
    ar: {
      ...
      feat1t: 'شفافية حية', feat1d: 'الأرقام والمستهدف والتقدم يمكن تحديثها مباشرة من Google Sheet دون تعديل يدوي.',
      feat2t: 'خريطة الإنجاز', feat2d: 'كل مسجد يظهر على خريطة السويد مع نافذة معلومات مختصرة وسهلة.',
      feat3t: 'تجربة راقية', feat3d: 'تصميم متجاوب، سريع، ومرتب مع دعم العربية والسويدية واتجاهي RTL وLTR.',
      ...
      valuesTitle: 'قيمنا', value1: 'الشفافية', value2: 'الأثر', value3: 'الاستدامة', value4: 'الشراكة المجتمعية',
      ...
      locationLabel: 'الموقع', amountLive: 'مؤشر حي', contactSuccess: 'شكراً لك. تم تجهيز النموذج لإرسال رسالتك مباشرة إلى بريد المنظمة.'
    },
    sv: {
      siteName: 'Vi Mår Bra',
      ...
      feat1t: 'Levande transparens', feat1d: 'Belopp, mål och framsteg kan uppdateras direkt från ett publicerat Google Sheet.',
      feat2t: 'Karta över insatserna', feat2d: 'Varje moské visas på Sverigekartan med en snabb informationsruta.',
      feat3t: 'Elegant upplevelse', feat3d: 'Responsiv, snabb och stilren design med stöd för både arabiska och svenska.',
      feat4t: 'Flera sätt att ge', feat4d: 'Donera via Swish, Stripe och PayPal eller bli stödmedlem direkt från sajten.',
      ...
      currentTitle: 'Aktuell kampanj', currentLead: 'Siffrorna för den aktuella kampanjen presenteras tydligt och kan synkas direkt från det publicerade Google Sheet-arket.',
      goal: 'Fullt mål', raised: 'Insamlat', remaining: 'Kvar', lastUpdated: 'Senast uppdaterad', donateNow: 'Stöd kampanjen nu',
      currentHint: 'Den här kortpanelen uppdateras live från den publicerade datakällan.', currentLocation: 'Plats för aktuell kampanj', liveSync: 'Live synk',
      ...
      valuesTitle: 'Våra värderingar', value1: 'Transparens', value2: 'Påverkan', value3: 'Hållbarhet', value4: 'Samhällspartnerskap',
      ...
      locationLabel: 'Plats', amountLive: 'Live indikator', contactSuccess: 'Tack. Formuläret är förberett för att skicka ditt meddelande direkt till organisationens e-post.'
    }
  };
